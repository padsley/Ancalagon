C     Standalone reference-value generator for the E1 electrostatic
C     deflector.
C
...
C     a grid of test points, using E1's actual parameters from
...
C
      ...
      ENDDO
C
C     'EDIP' 'E1 ' card, dat/dragon_2014_DSSSD.dat
C
      DATA(1)  = 1.D0
      DATA(2)  = 100.D0
      DATA(3)  = 100.D0
      ...
      DATA(40) = -0.80791D0
C
      OPEN(UNIT=30, FILE='e1_fortran_reference.csv', STATUS='UNKNOWN')
...
C
      CLOSE(30)
C
      WRITE(6,*) 'Wrote e1_fortran_reference.csv'
C
      END
